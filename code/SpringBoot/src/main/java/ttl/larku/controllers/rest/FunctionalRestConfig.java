...
class FunctionalStudentHandler {
    ...
    public ServerResponse getAllStudents(ServerRequest request) {
        ...
        return ServerResponse.ok().body(new RestResult().entity(students));
    }
    ...
    public ServerResponse createStudent(ServerRequest request) throws ServletException, IOException {
        ...
        return ServerResponse.created(newResource).body(new RestResult(s));
    }
    ...
    public ServerResponse getStudent(ServerRequest request) {
        ...
        if (s == null) {
            return ServerResponse.badRequest().body(new RestResult(RestResult.Status.Error,
                    "Student with id: " + id + " not found"));
        }
        return ServerResponse.ok().body(new RestResult(s));
    }
