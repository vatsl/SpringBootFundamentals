...
public class TrackerTestDataConfig {
    ...
    public Track track1() {
        Track track = Track.title("The Shadow Of Your Smile").artist("Big John Patton")
                .album("Let 'em Roll").duration("06:15").date("1965-01-03").build();
        return track;
    }
    ...
    public Track track2() {
        Track track = Track.title("I'll Remember April").artist("Jim Hall and Ron Carter")
                .album("Alone Together").duration("05:54").date("1972-01-03").build();
        return track;
    }
    ...
    public List<Track> tracks() {
        ...
        tracks.add(Track.title("Leave It to Me").artist("Herb Ellis")
                .album("Three Guitars in Bossa Nova Time").duration("03:13").date("1963-01-03").build());

        tracks.add(Track.title("Have you met Miss Jones").artist("George Van Eps")
                .album("Pioneers of the Electric Guitar").duration("02:18").date("2013-01-03").build());
